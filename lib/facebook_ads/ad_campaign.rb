...
module FacebookAds
  ...
  class AdCampaign < Base
    ...
    def create_ad_set(name:, promoted_object: {}, targeting:, daily_budget: nil, lifetime_budget: nil, end_time: nil, optimization_goal:, billing_event: 'IMPRESSIONS', status: 'ACTIVE', bid_strategy: nil, bid_amount: nil, access_token: '')
      ...
      AdSet.find(result['id'], query: { access_token: access_token })
    end
